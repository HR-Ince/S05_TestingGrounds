...
void AFirstPersonCharacter::BeginPlay()
{
	...
	const FRotator SpawnRotation = Mesh1P->GetSocketRotation("GripPoint");
	...
	auto Gun = GetWorld()->SpawnActor<AGun_Rifle>(GunBlueprint);
	...
	InputComponent->BindAction("Fire", IE_Pressed, Gun, &AGun_Rifle::OnFire);
